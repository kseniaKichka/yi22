    ...
    <div class="block">
        ...
        <div class="block-content collapse in">
            <div class="span12">
                ...
                <div class="controls">
                    <?= $form->field($blogData[2], 'translate')->textInput(['class' => 'span6', ]) ?>
                </div>
                <div class="controls">
                    <?= $form->field($model, 'active')->textInput(['class' => 'span6']) ?>
                </div>
                <div class="controls">
                    <?= $form->field($model, 'idAuthor')->dropDownList(\yii\helpers\ArrayHelper::map($userData,'id_user', 'soname')); ?>
                </div>
                <div class="controls">
                    <?= $form->field($model, 'id_tag')->textarea(['rows' => '8', 'class' => 'span6']) ?>
                </div>
                <div class="controls">
                    <?= $form->field($model, 'id_category')->textarea(['rows' => '8', 'class' => 'span6']) ?>
                </div>
                <div class="controls">
                    <?= $form->field($blogData[1], 'translate')->textarea(['rows' => '8', 'class' => 'span6']) ?>
                </div>
                <div class="controls">
                    <?= $form->field($blogData[0], 'translate')->textarea(['rows' => '8', 'class' => 'span6']) ?>
                </div>
